...
import dev.dejay.ezlib.MockedBukkitTest;
...
public class ItemStackBuilderTest extends MockedBukkitTest {
    ...
    public void throwsOnEmptyBuilder() {
        Assertions.assertThrows(IllegalStateException.class, () -> new ItemStackBuilder().item(), "Cannot build item without a specified material");
    }
